...
int main() {
    ...
    for(size_t i = 0; i < I.size(); i++) {
        ...
        range_vec.emplace_back(Range(Fr::zero(), -Fr::one(), size_t(256)));
        // range_vec.emplace_back(Range(Fr::zero(), -Fr::one(), size_t(16)));
    }
